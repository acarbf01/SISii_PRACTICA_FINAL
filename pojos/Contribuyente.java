...
public class Contribuyente  implements java.io.Serializable {
    ...
    public Contribuyente(String nombre, String apellido1, String nifnie, String direccion, Date fechaAlta) {
        this.nombre = nombre;
    ...
    public Contribuyente(String nombre, String apellido1, String apellido2, String nifnie, String direccion, String numero, String paisCcc, String ccc, String iban, String eemail, Character exencion, Double bonificacion, Date fechaAlta, Date fechaBaja, Set relContribuyenteOrdenanzas, Set lecturases, Set reciboses) {
       this.nombre = nombre;
       this.apellido1 = apellido1;
