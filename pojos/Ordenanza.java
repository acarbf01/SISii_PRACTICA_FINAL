...
public class Ordenanza  implements java.io.Serializable {
    ...
    public Ordenanza(int idOrdenanza, String concepto, String subconcepto, String descripcion) {
        this.idOrdenanza = idOrdenanza;
        this.concepto = concepto;
        this.subconcepto = subconcepto;
        this.descripcion = descripcion;
    }
    public Ordenanza(int idOrdenanza, String concepto, String subconcepto, String descripcion, String acumulable, Integer precioFijo, Integer m3incluidos, Double preciom3, Double porcentaje, Integer conceptoRelacionado, Double iva, String pueblo, String tipoCalculo, Set relContribuyenteOrdenanzas) {
       this.idOrdenanza = idOrdenanza;
       this.concepto = concepto;
       this.subconcepto = subconcepto;
       this.descripcion = descripcion;
